	...
	if(isset($_POST['submit']))
	{
		...
		{	
				...
				if($wszystko_OK==true)
			{
				...
				$datadodania=date('Y-m-d');
				$datadodaniaoff=date('Y-m-d H:i:s');

				if($polaczenie->query("INSERT INTO zamowienia VALUES (NULL, '$id' , '$adres', '$telefon' , '$imienaz' , '$opis' , '$notatki' , '$datazam1' , '$datazam2' , '$kwota' , 'aktywne' , '', '$datadodaniaoff' , '{$_SESSION["id"]}' ,'$datadodaniaoff' , '{$_SESSION["id"]}' )"))
				{
					
					//pobranie numeru tego zamówienia
					$rezu = mysqli_query($polaczenie, "Select zamowienia.idzam from zamowienia WHERE idgrpzam='$id' and adreszam='$adres' and telefonzam='$telefon' and imienazwiskozam='$imienaz' and opiszam='$opis' and notatkizam='$notatki' and data1zam='$datazam1' and data2zam='$datazam2' and kwotazam='$kwota' and status='aktywne' and datadodaniazam='$datadodaniaoff' and iddodajacego='{$_SESSION["id"]}'");
										$ile = mysqli_num_rows($rezu);
										for ($a= 1; $a <= $ile; $a++) 
										{
				...
				if(isset($_FILES['file'])) 
							...
							if (in_array($file_ext, $allowed))
							{
								if($file_error == 0)
								{
									...
									{		
										...
										//echo  $file_name_new;
													$sql = "INSERT INTO zdjecia (lokalizacja, idz) VALUES ('$file_destination', '$idzam')";			 
					...
					if($zdjeciaOK == false)
					{
						...
						$rezultat = mysqli_query($polaczenie, "DELETE FROM zamowienia WHERE idzam = '$idzam' ");
					...
					{	
						...
						header("Location: dodanezam.php?id=$id&idzam=$idzam");	
						//echo "true";
					}					
				}
				else
...
<body>
	...
	<div class="row" style="background-color:#08039e; text-align:center;">
				...
				<div class="z11">
				Adres: <br/><textarea  class="slowoz"  name="adres" rows="2" />
						<?php
				...
				<div class="z22">
				Telefon: <br/><textarea  class="slowoz"  name="telefon" rows="2"  />
						<?php
				...
				<div class="z11">
				Imię i Nazwisko: <br/><textarea  class="slowoz"  name="imienaz" rows="2"  />
						<?php
				...
				<label  class="zal">
				Załącz zdjęcia: <br/>
				<input type='file' name='file[]' id='file' multiple class="polezdj"></br><p3 style="color:yellow; font-size:10px; font-weight:600;">Jeżeli przy dodawaniu zamówienia wystąpi błąd, załączone&nbsp;zdjęcia&nbsp;zostaną&nbsp;usunięte!</p3></label>
				<?php
				...
				<div class="z22">
				Kwota: <br/><textarea  class="slowoz"  name="kwota" rows="2" />
						<?php
				...
				<div class="z11" style="padding:15px 0px 20px 0px;">
				<div style="padding:0px 0px 5px 0px;">Planowana data dostawy<br/>(&nbsp;zakres&nbsp;dni&nbsp;) [RRRR-MM-DD]<br/></div>
				<?php
		...
		<label class="dodajz">
		Dodaj zamówienie
		<input type="submit" value="Dodaj zamówienie" name="submit" style="display:none"/>
		</label>
