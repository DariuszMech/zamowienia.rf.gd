...
echo<<<END
		...
		<div class="col-6">
		<a href="dodajczlonka.php?id=$id " class="link">
			<div class="szef1">
				Dodaj </br>członka</br>
				<i class="icon-dodajczl" style="font-size:30px; color:#35e329;"></i>
			</div>
		</a>
		</div>
		
		<div class="col-6">
		<a href='usunczlonka.php?id=$id' class="link">
			<div class="szef1">
				Usuń </br>członka </br>
				<i class="icon-usunczl"  style="font-size:30px; color:#ff0000;" ></i>
			</div>
		</a>
		</div>
		...
		<div class="col-12">
		<label class="link">
			<div class="szef2"><i class="icon-usun" ></i> Usuń grupę
				<form action="usungrupe.php?id=$id" method="post" onsubmit="if (!confirm('Czy na pewno chcesz usunąć grupę $nazwag?')) return false">
					<input type="submit" value="usuń grupę" name="submit" style="display: none;"/>
				</form>
			</div>
		</label>	
		</div>
