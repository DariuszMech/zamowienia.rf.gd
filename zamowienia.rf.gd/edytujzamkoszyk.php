...
<body>
	...
	<main>
			...
			<div class="contaiiner">
						...
						<?php	
							echo "<nav class='sticky'><a href='zamowieniekoszyk.php?id=$id&idzam=$idzam' class='link'><div class='cofnij'>COFNIJ</div></a><a href='menu.php' class='link'><div class='cofnijmenu'>MENU</div></a></nav>";
						?>
						<header class="col-12">
